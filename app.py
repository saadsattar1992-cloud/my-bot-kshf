...
from telegram.ext import Updater, CommandHandler, CallbackQueryHandler, MessageHandler, CallbackContext, ChatMemberHandler, Filters
...
if __name__ == "__main__":
    if WEBHOOK_URL:
        app_instance.run(host='0.0.0.0', port=int(os.environ.get("PORT", 8080)), debug=False)
    else:
        main()